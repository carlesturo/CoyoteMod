...
MigrationGroupDefinitions["coyote"].possibleBreed = "eastern"; -- list separated by ","
...
MigrationGroupDefinitions["coyote"].trackSize = "medium"; -- used when investigating a track, if your level in tracking is too low you'll see "large" "medium" etc. otherwise the name of the animal.

MigrationGroupDefinitions["medium"] = MigrationGroupDefinitions["medium"] or {};
MigrationGroupDefinitions["medium"].groups = MigrationGroupDefinitions["medium"].groups or {};
MigrationGroupDefinitions["medium"].groups.coyote = {};
MigrationGroupDefinitions["medium"].groups.coyote.animal ="coyote";
MigrationGroupDefinitions["medium"].groups.coyote.chance = 100;